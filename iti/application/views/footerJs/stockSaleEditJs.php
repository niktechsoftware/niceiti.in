		...
		<script>
			...
			jQuery(document).ready(function() {
				...
				$("#billNo12").keyup(function(){
					...
					//alert(billNo);
					$.post("<?php echo site_url("index.php/feeControllers/printDueById") ?>",{billNo : billNo}, function(data){
						$("#saleDetail").html(data);
					});
					
				});

				$("#billNo12e").keyup(function(){
					var billNo = $("#billNo12e").val();
					//alert(billNo);
					$.post("<?php echo site_url("index.php/feeControllers/printDueByIdE") ?>",{billNo : billNo}, function(data){
						$("#saleDetail12").html(data);
					});
